...
public class SpringHibernateConfig {
    ...
    private Properties hibernateProperties(){
        ...
        properties.setProperty(
                "hibernate.hbm2ddl.auto", "none");   //burda menim entitylerimi yaradacaq amma burda create-drop olsayddi databasede olanlari silecek ve menim entitylerimi yaradacaq
        properties.setProperty(
